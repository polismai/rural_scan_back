...
//   beforeAll(async () => {
//     const mockUsersService: Partial<UsersService> = {
//       findByUsernameWithPassword: () => Promise.resolve(undefined),
//       findOneByUsername: jest.fn(),
//     };
//     const mockUserActivityService: Partial<UserActivityService> = {
//       logActivity: jest.fn().mockResolvedValue({
...
//           useValue: {
//             get: jest.fn((key: string) => {
//               if (key === 'SUPERADMIN_USERNAME') {
//                 return 'super_usuario';
//               } else if (key === 'SUPERADMIN_PASSWORD') {
...
//   it('Login como superadmin', async () => {
//     const llamada = await authService.login({
//       username: 'super_usuario',
//       password: 'super_password',
//     });
//     expect(llamada.token).toBe('mockedToken');
//   });
...
//     expect(result.username).toBe('usuario_correcto');
//     expect(userActivityService.logActivity).toHaveBeenCalledWith(
//       '3139ae8b-ee8d-4715-bf4b-77cc128bd99f',
//       'login',
//     );
//   });

//   it('Debe realizar correctamente el logout y registrar la actividad', async () => {
//     // Simulamos el usuario activo que será pasado al método logout
//     const mockUser = {
//       id: '3139ae8b-ee8d-4715-bf4b-77cc128bd99f',
//       username: 'usuario_correcto',
//       role: UserRole.ADMIN,
...
//     // Verificamos que el servicio de actividad de usuario fue llamado con los parámetros correctos
//     expect(userActivityService.logActivity).toHaveBeenCalledWith(
//       mockUser.id,
//       'logout',
//     );
...
//   it('Debe devolver el perfil del usuario activo', async () => {
//     // Simulamos el usuario activo que será pasado al método profile
//     const mockUser = {
//       id: '3139ae8b-ee8d-4715-bf4b-77cc128bd99f',
//       username: 'usuario_correcto',
//       password: await bcryptjs.hash('user-password', 10),
...
//     jest.spyOn(usersService, 'findOneByUsername').mockResolvedValue(mockUser);
//     // Llamamos al método profile del servicio
//     const profileResponse = await authService.profile(mockUser);

//     // Verificamos que el perfil devuelto sea el mismo que el usuario activo
//     expect(profileResponse).toEqual(mockUser);
//   });
// });
